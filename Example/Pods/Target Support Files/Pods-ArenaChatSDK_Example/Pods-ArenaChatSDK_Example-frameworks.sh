...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ArenaChatSDK/ArenaChatSDK.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ArenaChatSDK/Configuration.framework"
fi
